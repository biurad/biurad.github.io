                    ...
                    <Row>
                        <Col md="6" sm="12" xs="12">
                            <div className="content">
                                ...
                                <p>Hello, will you like to get started with us. Everything we work on is a big deal to us.</p>
                                <ul>
                                    <li><Button href="#home" bsPrefix="button">Get Started</Button></li>
                                    <li><Button href="#home" bsPrefix="button" variant="secondary">Free Trial</Button></li>
                                </ul>
                            </div>
                        </Col>
                        <Col md="6" sm="12" xs="12">
